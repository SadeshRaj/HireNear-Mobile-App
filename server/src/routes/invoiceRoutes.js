...
const {
    createInvoice, getInvoiceByBooking, uploadPaymentSlip, getWorkerEarnings, verifyPayment, rejectPaymentSlip, updateInvoice, deleteInvoice, markPaidInCash
...
router.patch('/:id/reject', protect, rejectPaymentSlip);
